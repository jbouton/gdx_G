...
public class AnimatedSprite extends Sprite {
	...
	public AnimatedSprite(Texture texture, int srcX, int srcY, int srcWidth, int srcHeight) {
	...
	public AnimatedSprite(TextureRegion region, int srcX, int srcY, int srcWidth, int srcHeight) {
